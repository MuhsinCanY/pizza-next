...
const PizzaCount = ({
  ...
  return (
    <div className="text-black flex">
      ...
      <span
        data-testid="pizza-count"
        className="flex items-center justify-center h-16 p-4 w-10 border-gray-300 border-[1px] border-r-0 border-l-0  text-xl"
      >
        {pizzaCount}
      </span>
      <button
        data-testid="pizza-count-minus"
